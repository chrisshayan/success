    ...
    render() {
        return (
            <div className={classNames('Home', 'foo', 'bar')}>
                ...
                <p>
                    For an in-depth example of how to use Meteor with React see <a
                    href="https://github.com/AdamBrodzinski/react-ive-meteor">Reactive Meteor</a>. For flux support see
                    the <a href="https://github.com/AdamBrodzinski/meteor-flux-leaderboard">Flux Leaderboard</a> example
                    app.
                </p>
                ...
                <ul>
                    <li>User</li>
                    <li>See more a complex <a
                        href="https://github.com/AdamBrodzinski/react-ive-meteor/blob/master/both/models/post.js">example</a>
                    </li>
                </ul>
