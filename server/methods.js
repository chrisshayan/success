...
Meteor.methods({
	...
	getSEOInfo(routeName, params) {
		check(routeName, String);
		let title = 'Success - Application Tracking System';
		let description = 'Success - Application Tracking System';

		const createSEOInfo = function(_title, _description) {
			return {
				'title': _title,
				meta: {
		...
		switch (routeName.toString().toLowerCase()) {

			case 'login':
				title = 'Login | Success - Application Tracking System';
				description = 'Login | Success - Application Tracking System';
				break;

			case 'dashboard':
				title = 'Dashboard | Success - Application Tracking System';
				description = 'Dashboard | Success - Application Tracking System';
				break;
			...
			case 'job':
				if(params.jobId) {
					...
					if(job) {
						title = job.jobTitle + ' | Success';
						description = job.jobTitle + ' | Success';
					}
				}
				break;
			...
			case 'jobsettings':
				if(params.jobId) {
					const job = JobExtra.findOne({jobId: +params.jobId});
					if(job) {
						title = 'Job settings | Success - Application Tracking System';
			...
			case 'hiringteam':
				title = 'Hiring Team | Success - Application Tracking System';
				description = 'Hiring Team | Success - Application Tracking System';
				break;

			case 'mailtemplates':
				title = 'Mail Templates | Success - Application Tracking System';
				description = 'Mail Templates | Success - Application Tracking System';
				break;

			case 'mention.hashtag':
				const tag = params.hashtag || '';
				title = `#${tag} | Success`;
				description = `#${tag} | Success`;
				break;
		}
